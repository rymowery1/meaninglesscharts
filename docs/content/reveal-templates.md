...
Paired 1:1 with `docs/content/fake-insight-templates.md`. Every reveal must make clear the chart doesn't support the fake insight — per CLAUDE.md, this is non-negotiable, not just tone.
